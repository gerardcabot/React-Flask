                      ...
                      {selectedGKSubViz === 'summaryAndCharts' && (
                        <div>
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
                            ...
                            <div style={{ background: '#f9fafb', padding: '1rem', borderRadius: '8px' }}>
                              <strong>{t('visualization.savePercentage')}</strong> {typeof gkAnalysisData.summary_text_stats?.save_percentage_direct_involvement === 'number' ? formatStat(gkAnalysisData.summary_text_stats?.save_percentage_direct_involvement) + "%" : t('visualization.na')}
                            </div>
                          </div>
                          <h4 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', marginBottom: '1rem' }}>
